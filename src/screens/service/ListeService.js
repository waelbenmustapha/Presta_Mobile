...
export default class ListeService extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://192.168.43.100:8090/categorie/getServiceByCategorie/" + this.props.route.params.item.id, {}, {
      auth: {
        username: "user",
        password: "0000"
      }
