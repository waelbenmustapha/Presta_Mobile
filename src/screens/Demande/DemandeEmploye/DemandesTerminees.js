...
import { FlatList,Image, Modal,Picker, View, StyleSheet, Text, SafeAreaView, ScrollView, TouchableOpacity, RefreshControl } from 'react-native';
...
export default function DemandesTerminees({navigation}) {
...
await axios.get("http://192.168.43.100:8090/demandeur/consulterDemandeur/"+tokeen).then(response => {
  ...
  async function demandesenattente(id) {
    ...
    axios.get("http://192.168.43.100:8090/demande/demandeEmploye/"+id+"/3", {}, {
      auth: {
        username: "user",
