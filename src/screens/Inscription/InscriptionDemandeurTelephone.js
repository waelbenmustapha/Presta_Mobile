...
import LoginDemandeur from '../Connexion/LoginDemandeur';

export default function InscriptionDemandeurTelephone({ route, navigation }) {
  let clockCall = null
...
const axiosApiCallAdd = () => {
  ...
  axios.post("http://192.168.43.100:8090/demandeur/ajouterDemandeur",
    {
      email: email,
    ...
    .then((response) => {
      Alert.alert("Compte ajouté avec succès");
